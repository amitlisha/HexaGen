...
HexagonsGame.record_step('orange_circle_1')
tile1 = Tile(4, 4)
tile1.draw('orange')
for i in range(6):
...
HexagonsGame.record_step('orange_circle_2')
tile1 = Tile(12, 3)
tile1.draw('orange')
for i in range(6):
    tile2 = tile1.neighbor('down_right')
...
HexagonsGame.record_step('orange_touching_1')
tile1 = Tile(7, 8)
...
HexagonsGame.record_step('orange_touching_2')
tile1 = Tile(7, 12)
for direction in DIRECTIONS:
    tile2 = tile1.neighbor(direction)
    tile2.draw('orange')
...
HexagonsGame.record_step('blue_circle')
tile1 = Tile(10, 5)
tile1.draw('blue')
for i in range(6):
    tile2 = tile1.neighbor('down_right')
