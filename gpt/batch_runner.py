...
def _build_retry_prompt(
    ...
    if cfg.mode == "code-full" and cfg.dataset != "larc":
        # Hexagen code-full: 3-space indented headers (matches full_runner.py)
        return base_prompt + (
            "\n\n"
            "   ### Your previous code\n"
            "   ```python\n"
        ...
        # LARC code-full, python-full (both datasets): no header indent
        return base_prompt + (
            "\n\n"
            "### Your previous code\n"
            "```python\n"
