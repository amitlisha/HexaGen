...
'''
HexagonsGame.record_step(step_name='7')
for r in range(6,10):
...
HexagonsGame.record_step(step_name='7_end')
...
'''
HexagonsGame.record_step(step_name='9')
for r in range(6,10):
...
HexagonsGame.record_step(step_name='9_end')

'''
10. Repeat step 9 for columns 10, 12 and 14.
'''
shape = HexagonsGame.get_record(step_names=['9'])
