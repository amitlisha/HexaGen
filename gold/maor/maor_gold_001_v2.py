...
with Game() as g:
    ...
    '''
    tile2 = tile1.neighbor(direction='up_right').neighbor(direction='up')
    tile2.draw('red')
    
    tile3 =tile1.neighbor(direction='down_right').neighbor(direction='down')
    tile3.draw('red')
    ...
    '''
    tile4 = tile1.neighbor(direction='down_left').neighbor(direction='up_left')
    tile4.draw('red')
