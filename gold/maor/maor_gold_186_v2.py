...
with Game() as g:
    ...
    '''
    for t, c in zip(line, ['purple', 'purple', 'green', 'purple', 'green', 'purple', 'purple', 'purple', 'green', 'green', 'purple', 'purple', 'green']):
      t.draw(c)
    ...
    '''
    for t, c in zip(line, ['blue', 'blue', 'orange', 'orange', 'blue', 'orange', 'orange', 'blue', 'blue', 'blue', 'orange', 'orange', 'blue', 'orange', 'orange', 'blue', 'orange', 'orange']):
      t.draw(c)
