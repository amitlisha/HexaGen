...
with Game() as g:
    ...
    '''
    zero2 = zero1.copy_paste(shift_direction='right', spacing=1)
    zero2.draw('orange')
    ...
    '''
    zero3 = zero2.copy_paste(shift_direction='right', spacing=1)
    zero3.draw('orange')
    
    zero4 = zero3.copy_paste(shift_direction='right', spacing=1)
    zero4.draw('purple')
    ...
    '''
    zero5 = zero1.copy_paste(shift_direction='down', spacing=2)
    zero5.draw('orange')
    
    zero6 = zero2.copy_paste(shift_direction='down', spacing=2)
    zero6.draw('purple')
    
    zero7 = zero3.copy_paste(shift_direction='down', spacing=2)
    zero7.draw('purple')
    
    zero8 = zero4.copy_paste(shift_direction='down', spacing=2)
    zero8.draw('purple')
    ...
    middle with blue.
    '''
    zero2.neighbors(criterion='inside').edge(direction='top').draw('green')
    zero2.neighbors(criterion='inside').edge(direction='down').draw('blue')
    
    zero5.neighbors(criterion='inside').edge(direction='top').draw('green')
