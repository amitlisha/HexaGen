...
with Game() as g:
    ...
    '''
    tile1 = blue_line.start_tile.neighbor('up_left')
    tile1.draw('blue')
    tile2 = blue_line.start_tile.neighbor('up_right')
    tile2.draw('blue')
    ...
    '''
    left_yellow = Line(start_tile=tile1.neighbor(direction='down'), direction='down', length=2, include_start_tile=False)
    left_yellow.draw('yellow')
    
    right_yellow = Line(start_tile=tile2.neighbor(direction='down'), direction='down', length=2, include_start_tile=False)
    ...
    '''
    left_orange = left_yellow.neighbors(criterion='up_left') + left_yellow.neighbors(criterion='down_left')
    left_orange.draw('orange')
    
    right_orange = right_yellow.neighbors(criterion='up_right') + right_yellow.neighbors(criterion='down_right')
    ...
    '''
    left_purple = Line(start_tile=left_orange.extreme('up').neighbor('up_left'), direction='down', length=5)
    left_purple.draw('purple')
    
    right_purple = Line(start_tile=right_orange.extreme('up').neighbor('up_right'), direction='down', length=5)
    ...
    '''
    left_red = left_purple.neighbors(criterion='up_left') + left_purple.neighbors(criterion='down_left')
    left_red.draw('red')
    
    right_red = right_purple.neighbors(criterion='up_right') + right_purple.neighbors(criterion='down_right')
    right_red.draw('red')
    ...
    right_green1 = Line(start_tile=right_red.edge('up').neighbor('up_right'), direction='down', length=3)
    right_green1.draw('green')
    
    right_green2 = Line(start_tile=right_green1.end_tile.neighbor(direction='down').neighbor(direction='down'), direction='down', length=2)
    right_green2.draw('green')
