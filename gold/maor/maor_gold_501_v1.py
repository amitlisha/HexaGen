...
four tiles long.
'''
line1 = Line(start_tile=tile1, direction='down_left', include_start_tile=True, length=4)
line1.draw(color)

line2 = Line(start_tile=tile1, direction='down_right', include_start_tile=True, length=4)
line2.draw(color)
...
'''
line3 = Line(start_tile=line1.end_tile, direction='down_right', include_start_tile=True, length=4)
line3.draw(color)

line4 = Line(start_tile=line2.end_tile, direction='down_left', include_start_tile=True, length=4)
line4.draw(color)
...
shape.get(criterion='inside').draw('blue')
