...
with Game() as g:
    ...
    of it orange.
    '''
    line2 = Line(start_tile=Tile(row=2, column=6), direction='up_right', length=4)
    line2.draw('orange')
    
    '''
    4. Paint 4 cells orange extending straight down from the yellow cell in step 2.
    '''
    line3 = Line(start_tile=Tile(row=4, column=5), direction='down', length=4)
    line3.draw('orange')
    
    '''
    5. Paint the cell directly below the line created in step 4 black.
    '''
    tile2 = Tile(row=8, column=5)
    tile2.draw('black')
    ...
    it.
    '''
    line4 = Line(start_tile=Tile(row=9, column=5), direction='down', length=2)
    line4.draw('orange')
    ...
    '''
    line5 = Line(start_tile=Tile(row=8, column=4), direction='down_left', length=4)
    line5.draw('purple')
    ...
    '''
    line5 = Line(start_tile=Tile(row=7, column=6), direction='up_right', length=6)
    line5.draw('purple')
    
    '''
    9. Extend the line in step 8 by adding 1 blue cell.
    '''
    tile3 = Tile(row=4, column=12)
    tile3.draw('blue')
    
    '''
    10. From the top of the blue cell, color 3 cells purple going straight up.
    '''
    line6 = Line(start_tile= Tile(row=3, column=12), direction='up', length=3)
    line6.draw('purple')
    ...
    '''
    line7 = Line(start_tile= Tile(row=5, column=13), direction='down_right', length=6)
    line7.draw('purple')
