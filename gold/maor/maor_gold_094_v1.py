...
with Game() as g:
    ...
    '''
    line1 = Line(start_tile=Tile(12,1), direction='down', length=3)
    line1.draw('purple')
    '''
    ...
    column.
    '''
    line2 = Line(start_tile=Tile(13,5), end_tile=Tile(18,7))
    line3 = Line(start_tile=Tile(11,5), end_tile=Tile(1,-1))
    line2.draw('purple')
    line3.draw('purple')
    '''
    ...
    line5 = Line(start_tile=tile2, end_tile=Tile(9,1), include_start_tile=False)
    line4.draw('orange')
    line5.draw('orange')
    '''
