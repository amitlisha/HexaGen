...
'''
for c in columns:
  line = Line(start_tile=Tile(column=c, row=4), end_tile=Tile(column=c, row=6))
  line.draw('yellow')
...
'''
for c in columns:
  line = Line(start_tile=Tile(column=c, row=7), end_tile=Tile(column=c, row=8))
  line.draw('red')
...
columns = [12, 8]
for c in columns:
  line = Line(start_tile=Tile(column=c, row=3), end_tile=Tile(column=c, row=5))
  line.draw('yellow')
