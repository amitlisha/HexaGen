...
with Game() as g:
    ...
    '''
    for c in columns:
      line = Line(start_tile=Tile(row=4, column=c), end_tile=Tile(row=6, column=c))
      line.draw('yellow')
    ...
    '''
    for c in columns:
      line = Line(start_tile=Tile(row=7, column=c), end_tile=Tile(row=8, column=c))
      line.draw('red')
    ...
    columns = [12, 8]
    for c in columns:
      line = Line(start_tile=Tile(row=3, column=c), end_tile=Tile(row=5, column=c))
      line.draw('yellow')
