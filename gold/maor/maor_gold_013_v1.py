...
with Game() as g:
    ...
    tile3.draw('blue')
    tile4 = Tile(column=13, row=3)
    tile4.draw('blue')
    
    tile5 = Tile(column=17, row=2)
    tile5.draw('blue')
    ...
    '''
    line1 = Line(start_tile=Tile(column=14,row=1), direction='down', length=3).draw('blue')
    line1.draw('blue')
    line2 = Line(start_tile=Tile(column=16,row=1), direction='down',length=3)
    line2.draw('blue')
    
    '''
    4. Fill in the top 4 spots on the 15th column.
    '''
    line3 = Line(start_tile=Tile(column=15,row=1), direction='down',length=4)
    line3.draw('blue')
