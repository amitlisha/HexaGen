...
with Game() as g:
    ...
    '''
    line1 = Line(start_tile=Tile(column=-2,row=2), direction='down', length=2)
    line1.draw('blue')
    
    '''
    3. In the third column from the right, color the topmost 3 blue.
    '''
    line2 = Line(start_tile=Tile(column=-3,row=1), direction='down', length=3)
    line2.draw('blue')
    
    '''
    4. In the 4th column from the right, color the topmost 4 blue.
    '''
    line3 = Line(start_tile=Tile(column=-4,row=1), direction='down', length=4)
    line3.draw('blue')
    
    '''
    5. In the 5th column from the right, color the topmost 3 blue.
    '''
    line4 = Line(start_tile=Tile(column=-5,row=1), direction='down', length=3)
    line4.draw('blue')
    
    '''
    6. In the 6th column from the right, color the 2nd and 3rd from the top blue.
    '''
    line5 = Line(start_tile=Tile(column=-6,row=2), direction='down', length=2)
    line5.draw('blue')
