...
with Game() as g:
    ...
    orange_tiles1 = Shape([Tile(3, 8).neighbor(d) for d in DIRECTIONS]).draw('orange')
    ...
    orange_tiles2 = Tile(3, 12).neighbors().draw('orange')
    ...
    Shape([Tile(7, 8)] + Tile(7, 8).neighbors().tiles).draw('orange')
    Tile(7, 8).draw('white')  # leave tile 8, 7 blank
    ...
    Shape([Tile(7, 12)] + Tile(7, 12).neighbors().tiles).draw('orange')
    Tile(7, 12).draw('white')  # leave tile 12, 7 blank
    ...
    blue_tiles = Shape([Tile(3, 10).neighbor(d) for d in DIRECTIONS]).draw('blue')
