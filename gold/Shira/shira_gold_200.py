...
with Game() as g:
    ...
    '''
    red_line = Line(start_tile = Tile(1, 3), end_tile = Tile(5, 1))
    red_line.draw('red')
    '''
    ...
    '''
    Tile(3, -1).draw('purple')
    Tile(3, -2).draw('purple')
    '''
    ...
    column = 5
    for i in range(7):
      Line(start_tile = Tile(column, -1), direction = 'up', end_tiles = Shape.get_color('red')).draw('purple')
      column += 2
