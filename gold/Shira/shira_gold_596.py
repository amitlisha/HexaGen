...
with Game() as g:
    ...
    line1.draw('blue')
    line2 = Line(start_tile=Tile(4, column), end_tile=Tile(6, column), direction='down')
    line2.draw('purple')
    line3 = Line(start_tile=Tile(7, column), end_tile=Tile(9, column), direction='down')
    line3.draw('yellow')
    '''
    ...
    line4.draw('purple')
    line5 = Line(start_tile=Tile(4, column), end_tile=Tile(6, column), direction='down')
    line5.draw('yellow')
    line6 = Line(start_tile=Tile(7, column), end_tile=Tile(9, column), direction='down')
    line6.draw('blue')
    '''
    ...
    line7.draw('yellow')
    line8 = Line(start_tile=Tile(4, column), end_tile=Tile(6, column), direction='down')
    line8.draw('blue')
    line9 = Line(start_tile=Tile(7, column), end_tile=Tile(9, column), direction='down')
    line9.draw('purple')
    '''
